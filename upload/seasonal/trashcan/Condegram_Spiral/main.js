...
d3.json("../data_week_state.json").get(function(error,data){
  ...
  var byDisease = data['DIPHTHERIA'];
  //console.log(byDisease);
  for(var j = 1916; j<=1921; j++){
    var temp = byDisease[j];
    //console.log(temp);
    temp.forEach(function(d) {
      aData.push({year:j,week:j*100+(d.week*100/52), cases:d.cases});
      //week.push(d.week);
    });
  }
console.log(aData);
...
var timeScale = d3.scaleLinear()
  .domain(d3.extent(aData, function(d){
    return d.week;
  }))
